...
public class MaximizeCapital {
     ...
     *  we need to find the most profitable projects. We are given an initial capital and are allowed to
     *  invest only in a fixed number of projects. Our goal is to choose projects that give us the maximum profit.
     ...
     *
     *  Pablo's notes: In one heap you keep capital from less to more. Then you pick all
     *  the ones you can do. You move them to max heap that sorts them by profit, so that you always
     *  pick max profit. You keep doing that until the you picked all projects
     */
    public int findMaximumCapital(int[] capital, int[] profits, int numberOfProjects, int initialCapital) {
        ...
        // insert all project capitals into min heap
        for (int i = 0; i < n; i++) {
