 ...
 *
 * Pablo's notes: The trick here is to keep and extra pointer last that you fill once
 * you reach the last inOrder traversal on the left side. Also the very first time you visit
 * the far left leaf, you fill a first pointer
 */
