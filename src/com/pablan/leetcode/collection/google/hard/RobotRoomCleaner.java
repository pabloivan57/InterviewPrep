...
public class RobotRoomCleaner implements Robot {
     ...
     * only the mentioned 4 APIs, without knowing the room layout and the initial robot's position.
    ...
    public RobotRoomCleaner(int row, int col, int[][] room) {
        this.row = row;
        this.column = col;
        this.room = room;
        this.visited = new int[room.length][room[0].length];
    }
